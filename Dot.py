...
class Dot:
    ...
    def score(self):
        ...
        if self.sprite is not None:
            dist_to_win = math.hypot(self.sprite.centerx - self.winning_area.sprite.centerx, self.sprite.centery - self.winning_area.sprite.centery)
            sqrt_nb_steps = self.current_move ** 3
            won_bonus = 0 if self.won else 10000
            died_bonus = 10000 if self.died else 0
            fitness_score = 1 / (dist_to_win + sqrt_nb_steps + won_bonus + died_bonus)
